...
function Clc = Create_Cxt_NL_CR400AF(InpPar, Par_Vehicle, DamperNL, C_vehicle_v0)
...
%         for i2 = 1:1:2
%             for i3 = 1:1:2
%                 pos_P = DOF_FW+35+20+4*(i1-1)+2*(i2-1)+i3;
%                 pos_C = DOF_FW+30;
% 
%                 if (i1==1&&i2==1) || (i1==2&&i2==2)
