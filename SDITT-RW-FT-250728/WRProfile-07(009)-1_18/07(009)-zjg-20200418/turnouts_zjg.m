...
%%%%%% 输入参数 %%%%%%
Name = {'3', '15', '27.4', '35', '40', '50', '60', '65', '65''', '72.2'};
Width_Range = [3 15 27.4 35 40 50 60 65 65 72.2]';
Mileage_origin = [3 15 26.8 27.4 35 40 50 60 65 72.2; 
                  0.575 2.889 5.161 5.280 6.569 7.304 8.614 9.753 10.269 10.962]';
Rail_Topic_Name_input = 'zjg-';
Rail_Topic_Name_output_zjg = '07(009)-zjg-20200418-';
