...
%%%%%% 输入参数 %%%%%%
Name = {'M', 'C', 'D', 'E', 'F1', 'F2'};
Width_Range = [12.5 22.5 40 50 68.7 71.3]';
Mileage_origin = [12.5 22.5 40 50 68.7 71.3; 
                  53.280 53.589 54.123 54.425 54.982 55.060 ]';
Rail_Topic_Name_input = 'cxg-';
Rail_Topic_Name_output_cxg = '07(009)-cxg-20200422-';
...
for i = 1:1:length(Width_Range)-1
    ...
    while judgement == 0
        ...
        %%%%%% 重新输出典型截面数据 %%%%%%
        filename1_output =  strcat(Rail_Topic_Name_output_cxg,num2str(Width_Range(i)));
        filename2_output =  strcat(Rail_Topic_Name_output_cxg,num2str(Width_Range(i+1)));
...
%             end
            ...
            filename3_output =  strcat(Rail_Topic_Name_output_cxg,num2str(z3));
