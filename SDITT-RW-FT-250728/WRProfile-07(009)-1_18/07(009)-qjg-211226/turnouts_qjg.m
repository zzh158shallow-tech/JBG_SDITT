...
clc
clear
path_keysec = 'E:\# Flex-Rigid-20200418\Profiles\07(009)-qjg-211226\';

%%%%%% 输入参数 %%%%%%
Name = {'B', 'C', 'D', 'N', 'E', 'F', '60', 'G1'};
Width_Range = [3 5 20 27.4 35 50 60 72.2]';
Mileage_origin = [3 5 20 26.8 27.4 35 50 60 69.2 72.2; 
                  0.578 0.964 3.855 5.168 5.280 6.574 8.604 9.756 10.670 10.970 ]';
Rail_Topic_Name_input = 'qjg_';
Rail_Topic_Name_output_zjg = '07(009)-qjg-211226-';
...
for i = 1:1:length(Width_Range)-1
    ...
    while judgement == 0
        ...
        %%%%%% 重新输出典型截面数据 %%%%%%
        filename1_output =  strcat(Rail_Topic_Name_output_zjg,num2str(Width_Range(i)));
        filename2_output =  strcat(Rail_Topic_Name_output_zjg,num2str(Width_Range(i+1)));
...
%         end
        ...
        for z3 =  round(l1)+1 : dz3 : ceil(l2)-1    %%%确定步长
            ...
            filename3_output =  strcat(Rail_Topic_Name_output_zjg,num2str(z3));
        ...
        %%%%%% 图例图例 %%%%%%
        lgd  =   num2str([l1,l2,round(l1)+1:dz3:ceil(l2)-1]','%gmm');%图例步长
        legend(lgd);
