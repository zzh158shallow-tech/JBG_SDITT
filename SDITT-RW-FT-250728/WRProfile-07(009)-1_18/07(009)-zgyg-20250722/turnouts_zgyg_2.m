...
clc
clear
path_keysec = 'H:\# Mango\2025-07-07 CARS-Turnout_V450\SDITT-RW-FT_Face\WRProfile-07(009)-1_18\07(009)-zgyg-20250722\Key profiles\';

%%%%%% 输入参数 %%%%%%
Name = {'D-20250722', 'E-20250722'};
Width_Range = [9.100 	49.80]';
Mileage_origin = [9.100 	49.80; 
                             53.176 54.419]';
Rail_Topic_Name_input = 'zgyg-';
Rail_Topic_Name_output = '07(009)-zgyg-20250722-cxg-';
...
for i = 1:1:1
    ...
    while judgement == 0
        ...
        figure(1)
        hold off;
        plot(targ1(:,1)*1000,targ1(:,2)*1000,'b--',targ2(:,1),targ2(:,2),'r--');
...
%         end
        ...
        for z3 =  floor(z1)+dz3 : dz3 : ceil(z2)-dz3    %%%确定步长
            ...
            figure(1)
            hold on;
            plot(targ3(:,1)*1000,targ3(:,2)*1000,'Color',[rand(),rand(),rand()]);
            set(gca,'ydir','reverse');
        end
