...
%%%%%% 输入参数 %%%%%%
Name = {'A', 'B', 'B1', 'B2', 'B3', 'B4', 'C'};
Width_Range = [71, 89.8, 95.414, 97.038, 106.489, 108.128, 110.97]';
Mileage_origin = [71, 89.8, 95.414, 97.038, 106.489, 108.128, 110.97; 
                  46.050, 52.483, 52.649, 52.699, 52.989, 53.039, 53.148]';
Rail_Topic_Name_input = 'zgyg-';
Rail_Topic_Name_output = '07(009)-zgyg-20200424-';
