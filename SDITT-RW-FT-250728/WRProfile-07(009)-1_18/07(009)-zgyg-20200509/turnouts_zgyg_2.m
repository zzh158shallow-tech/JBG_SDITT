...
clear
clc
path_keysec = 'D:\# Flex-Rigid-20200418\Profiles\07(009)-zgyg-20200509\Key profiles\';

%%%%%% 输入参数 %%%%%%
Name = {'D', 'E1', 'E12', 'E13', 'E14', 'E2', 'E3', 'E4', 'E41', 'E42', 'E5'};
Width_Range = [9.100 	18.409 	21.167 	23.053 	23.868 	24.911 	35.655 	50.334 	61.248 	62.089 	71.300]';
Mileage_origin = [9.100 18.409 	21.167 	23.053 	23.868 	24.911 	35.655 	50.334 	61.248 	62.089 	71.300; 
                  53.176 53.463 53.548 	53.606 	53.631 	53.663 	53.991 	54.435 	54.760 	54.785 	55.060]';
Rail_Topic_Name_input = 'zgyg-';
Rail_Topic_Name_output = '07(009)-zgyg-20200509-cxg-';
